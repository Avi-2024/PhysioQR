...
const AgentEditDoctorPage = lazy(() => import('@/features/agents/pages/doctors/AgentEditDoctorPage'));
...
export const agentRoutes: RouteObject = {
  ...
  children: [
    ...
    { path: 'doctors/:doctorId/edit', element: withSuspense(<AgentEditDoctorPage />) },
    ...
    { path: 'notifications', element: withSuspense(<AgentNotificationsPage />) },
    { path: 'profile', element: withSuspense(<AgentProfilePage />) },
  ],
};
