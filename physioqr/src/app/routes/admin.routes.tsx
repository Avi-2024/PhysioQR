...
const AdminNotificationDetailPage = lazy(() => import('@/features/admin/pages/notifications/AdminNotificationDetailPage'));
...
const AdminFraudRiskDetailPage = lazy(() => import('@/features/admin/pages/risk/AdminFraudRiskDetailPage'));
const AdminAuditLogsPage = lazy(() => import('@/features/admin/pages/risk/AdminAuditLogsPage'));
const AdminAuditLogDetailPage = lazy(() => import('@/features/admin/pages/risk/AdminAuditLogDetailPage'));
...
export const adminRoutes: RouteObject = { path: '/admin', element: <ProtectedRoute><RoleProtectedRoute allowedRoles={['admin']}><AdminLayout /></RoleProtectedRoute></ProtectedRoute>, children: [
  ...
  { path: 'notifications', element: withSuspense(<AdminNotificationsPage />) }, { path: 'notifications/:notificationId', element: withSuspense(<AdminNotificationDetailPage />) }, { path: 'support', element: withSuspense(<AdminSupportPage />) }, { path: 'support/:ticketId', element: withSuspense(<AdminSupportTicketDetailPage />) }, { path: 'reports', element: withSuspense(<AdminReportsPage />) }, { path: 'fraud-risk', element: withSuspense(<AdminFraudRiskPage />) }, { path: 'fraud-risk/:fraudCaseId', element: withSuspense(<AdminFraudRiskDetailPage />) }, { path: 'audit-logs', element: withSuspense(<AdminAuditLogsPage />) }, { path: 'audit-logs/:auditLogId', element: withSuspense(<AdminAuditLogDetailPage />) }, { path: 'settings', element: withSuspense(<AdminSettingsPage />) },
] };