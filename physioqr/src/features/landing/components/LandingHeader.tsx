...
export function LandingHeader({ onOpenPortal }: LandingHeaderProps) {
  ...
  return (
    <>
      ...
      >
        <div
          className="rc-container rc-landing-header-grid"
          style={{
            width: '100%',
            display: 'grid',
            gridTemplateColumns: '260px minmax(0, 1fr) 160px',
            alignItems: 'center',
            gap: '12px',
          }}
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '8px', flexShrink: 0 }}>
            ...
            <button
              ...
              className="lg:hidden"
              style={{ border: 'none', background: 'transparent', padding: '10px', minHeight: '44px', minWidth: '44px', color: 'var(--text-primary)', cursor: 'pointer' }}
