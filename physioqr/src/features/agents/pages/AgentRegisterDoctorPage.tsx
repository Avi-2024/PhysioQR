    ...
    return (
      <div className="mx-auto max-w-2xl space-y-5">
        <div className="rounded-2xl border border-emerald-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <p className="mt-2 text-sm text-neutral-600">The doctor is active immediately. Admin can review or change the doctor status and detailed commercial settings later.</p>
    ...
    <div className="mx-auto max-w-3xl space-y-5">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-neutral-500">Add the essential details. Agent-registered doctors are approved automatically.</p>
        </div>
      </div>
